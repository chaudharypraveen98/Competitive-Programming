...
2. requestAnimationFrame() method tells the browser that you wish to call a specified function to update an animation before the next repaint. These tasks are queued to the Animation Queue
...
[Event Loops](https://www.youtube.com/watch?v=cCOL7MC4Pl0)