## [109. isNaN()](https://bigfrontend.dev/quiz/isNaN)
...
Basically As opposed to the global isNaN() function, the Number.isNaN() method doesn't force-convert the parameter to a number. In simple words, Number.isNaN only returns true when the operand is NaN. However, isNaN will actually typecast the operand to a number and then evaluate.
