## [108. property key](https://bigfrontend.dev/quiz/property-key)

### Approach
In Javascript, objects are used to store various keyed collections i.e key-value pairs. To access the values we utilise Property Accessors.
